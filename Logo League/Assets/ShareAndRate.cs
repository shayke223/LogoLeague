...
public class ShareAndRate : MonoBehaviour
{
    ...
    string subject = "QuizGame";
  
    string body = "Let's play together https://play.google.com/store/apps/details?id=com.YumaApps.LogoLeague&rdid=com.YumaApps.LogoLeague";
#if UNITY_IPHONE
 ...
 private static extern void sampleTextMethod (string message);
  ...
  sampleTextMethod (shareMessage);
    ...
    {
#if UNITY_ANDROID
        Application.OpenURL("https://play.google.com/store/apps/details?id=com.YumaApps.LogoLeague&rdid=com.YumaApps.LogoLeague");
#elif UNITY_IPHONE
